...
fetch_shots_by_player_id_and_season = function(player_id, season, minutes) {
...
default_shots = fetch_shots_by_player_id_and_season(default_player$person_id, default_season,5)
